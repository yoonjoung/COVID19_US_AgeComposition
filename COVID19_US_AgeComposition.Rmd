...
## CSV
url<-("https://data.cdc.gov/resource/vbim-akqf.csv")
...
dtasurveillance<-read.csv("C:/Users/YoonJoung Choi/Dropbox/0 Project/COVID19_US/DataCDC/COVID-19_Case_Surveillance_Public_Use_Data.csv")    
    ...
    #table(dta$cdc_case_earliest_dt)    
...
dtamonthly<-dtacase%>%
    ...
    mutate(raceagegroupmonth=paste0(racegroup,"_",agegroup,"_",yearmonth))%>%
...
write.csv(dtamonthly, "X_COVID19_US_AgeComposition/dtamonthly_202010224.csv")
```
...
write.csv(dtaweekly, "X_COVID19_US_AgeComposition/dtaweekly_2021.csv")
```
...
latestdate<-as.character(as.Date.POSIXct(max(dtacase$cdc_case_earliest_dt)))
...
* Accessed on February 26, 2021 (version released on February 24, 2021)   
* Latest report date is February 5, 2021.    
...
```{r overall_plotagecomposition, results="asis", results="asis", fig.align="left", out.width="1000px", out.height="300px"}
dtafig%>%
    plot_ly(x=~group,
            y = ~pct, type = "bar",
             color= ~agegroup, 
...
```{r overall_plotagecomposition_trend1, results="asis", fig.align="left", out.width="1000px", out.height="300px"}
...
```{r overall_plotagecomposition_trend2, results="asis", fig.align="left", out.width="1000px", out.height="300px"}
...
```{r overall_plotagecomposition_hosp_trend1, results="asis", fig.align="left", out.width="1000px", out.height="300px"}
...
```{r overall_plotagecomposition_hosp_trend2, results="asis", fig.align="left", out.width="1000px", out.height="300px"}
...
```{r overall_plotagecomposition_death_trend1, results="asis", fig.align="left", out.width="1000px", out.height="300px"}
...
```{r overall_plotagecomposition_death_trend2, results="asis", fig.align="left", out.width="1000px", out.height="300px"}
...
```{r overall_plotracecomposition, results="asis", fig.align="left", out.width="1000px", out.height="300px"}
...
```{r overall_plotracecomposition_trend1, results="asis", fig.align="left", out.width="1000px", out.height="300px"}
...
(only weeks with more than 20 cases)
```{r overall_plotracecomposition_trend2, results="asis", fig.align="left", out.width="1000px", out.height="300px"}
...
```{r overall_plotracecomposition_death_trend1, results="asis", fig.align="left", out.width="1000px", out.height="300px"}
...
(only weeks with more than 20 deaths)
```{r overall_plotracecomposition_death_trend2, results="asis", fig.align="left", out.width="1000px", out.height="300px"}
...
```{r overall_plotracecomposition_knownrace, results="asis", fig.align="left", out.width="1000px", out.height="300px"}
dtafig%>%
    plot_ly(x=~group,
            y = ~pct, type = "bar",
             color= ~racegroup , 
...
```{r overall_plotracecomposition_case_trend1_knownrace, results="asis", fig.align="left", out.width="1000px", out.height="300px"}
...
(only weeks with more than 20 cases)
```{r overall_plotracecomposition_case_trend2_knownrace, results="asis", fig.align="left", out.width="1000px", out.height="300px"}
...
```{r overall_plotracecomposition_hosp_trend1_knownrace, results="asis", fig.align="left", out.width="1000px", out.height="300px"}
...
(only weeks with more than 20 hospitalizations)
```{r overall_plotracecomposition_hosp_trend2_knownrace, results="asis", fig.align="left", out.width="1000px", out.height="300px"}
...
```{r overall_plotracecomposition_death_trend1_knownrace, results="asis", fig.align="left", out.width="1000px", out.height="300px"}
...
(only weeks with more than 20 deaths)
```{r overall_plotracecomposition_death_trend2_knownrace, results="asis", fig.align="left", out.width="1000px", out.height="300px"}
...
```{r plotagecomposition1-1, results="asis", results="asis", fig.align="left", out.width="1000px", out.height="300px"}
dtafig%>% 
...
```{r plotagecomposition1-2, , results="asis", fig.align="left", out.width="1000px", out.height="300px"}
dtafig%>% 
...
```{r plotagecomposition1-3, , results="asis", fig.align="left", out.width="1000px", out.height="300px"}
dtafig%>% 
...
```{r plotagecomposition1-4, , results="asis", fig.align="left", out.width="1000px", out.height="300px"}
dtafig%>% 
...
```{r plotagecomposition2, results="asis", fig.align="left", out.width="1000px", out.height="800px"}
panel <- . %>% 
    plot_ly(x=~group,
            y = ~pct, type = "bar",
             color= ~agegroup, 
...
(only weeks with more than 20 cases)
```{r plotagecomposition_trend_case_pct, results="asis", fig.align="left", out.width="1000px", out.height="800px"}
dtafig%>%
    filter(group=="Cases")%>%
    filter(total>20)%>%
    group_by(racegroup) %>%
...
(only weeks with more than 20 hospitalizations)
```{r plotagecomposition_trend_hosp_pct, results="asis", fig.align="left", out.width="1000px", out.height="800px"}
dtafig%>%
...
(only weeks with more than 20 deaths)
```{r plotagecomposition_trend_death_pct, results="asis", fig.align="left", out.width="1000px", out.height="800px"}
dtafig%>%
    filter(group=="Deaths")%>%
    filter(total>20)%>%
    group_by(racegroup) %>%
...
```{r plotagecomposition_trend_case_num, results="asis", fig.align="left", out.width="1000px", out.height="800px"}
dtafig%>%
    filter(group=="Cases")%>%
    group_by(racegroup) %>%
    do(p = panel(.)) %>%
...
```{r plotagecomposition_trend_hosp_num, results="asis", fig.align="left", out.width="1000px", out.height="800px"}
dtafig%>%
    filter(group=="hospitalizations")%>%
    group_by(racegroup) %>%
    do(p = panel(.)) %>%
...
```{r plotagecomposition_trend_death_num, results="asis", fig.align="left", out.width="1000px", out.height="800px"}
dtafig%>%
    filter(group=="Deaths")%>%
    group_by(racegroup) %>%
    do(p = panel(.)) %>%
...
(only weeks with more than 20 cases)
```{r plotagecomposition_weeklytrend_case_pct, results="asis", fig.align="left", out.width="1000px", out.height="800px"}
dtafig%>%
    filter(group=="Cases")%>%
    filter(total>20)%>%
    group_by(racegroup) %>%
...
(only weeks with more than 20 hospitalizations)
```{r plotagecomposition_weeklytrend_hosp_pct, results="asis", fig.align="left", out.width="1000px", out.height="800px"}
dtafig%>%
    filter(group=="hospitalizations")%>%
    filter(total>20)%>%
    group_by(racegroup) %>%
...
(only weeks with more than 20 deaths)
```{r plotagecomposition_weeklytrend_death_pct, results="asis", fig.align="left", out.width="1000px", out.height="800px"}
dtafig%>%
    filter(group=="Deaths")%>%
    filter(total>20)%>%
    group_by(racegroup) %>%
...
```{r plotagecomposition_weeklytrend_death_pct2, results="asis", fig.align="left", out.width="1000px", out.height="800px"}
dtafig%>%
    filter(group=="Deaths")%>%
    filter(total>30)%>%
    group_by(racegroup) %>%
...
```{r plotagecomposition_weeklytrend_case_count, results="asis", fig.align="left", out.width="1000px", out.height="800px"}
dtafig%>%
    filter(group=="Cases")%>%
    group_by(racegroup) %>%
    do(p = panel(.)) %>%
...
```{r plotagecomposition_weeklytrend_hosp_count, results="asis", fig.align="left", out.width="1000px", out.height="800px"}
dtafig%>%
    filter(group=="hospitalizations")%>%
    group_by(racegroup) %>%
    do(p = panel(.)) %>%
...
```{r plotagecomposition_weeklytrend_death_count, results="asis", fig.align="left", out.width="1000px", out.height="800px"}
dtafig%>%
    filter(group=="Deaths")%>%
    group_by(racegroup) %>%
    do(p = panel(.)) %>%
...
```{r plotcfr, results="asis", fig.align="left", out.width="1000px", out.height="800px"}
...
```{r plotcfr_byrace, results="asis", fig.align="left", out.width="1000px", out.height="800px"}
...
```{r fig1, results="asis", fig.align="left", out.width="1000px", out.height="300px"}
...
```{r fig2, results="asis", fig.align="left", out.width="1000px", out.height="800px"}
subplot(
        fig2case %>% 
...
```{r fig3option1, results="asis", fig.align="left", out.width="1000px", out.height="350px"}
...
```{r fig3option2, results="asis", fig.align="left", out.width="1000px", out.height="400px"}
...
```{r fig3option2_linear, results="asis", fig.align="left", out.width="1000px", out.height="400px"}
...
```{r fig3option3, results="asis", fig.align="left", out.width="1000px", out.height="400px"}
...
```{r fig3option3_linear, results="asis", fig.align="left", out.width="1000px", out.height="400px"}
